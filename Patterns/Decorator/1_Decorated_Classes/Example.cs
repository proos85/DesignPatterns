...
namespace Patterns.Decorator._1_Decorated_Classes
{
    public static class Example
    {
        ...
        private static void OrderNyStylePizza()
        {
            ...
            var pizzaAndExtraMushroomsAndOnions = nyPizzaStore.OrderPizza(PizzaType.CheeseAndExtraMushroomsAndOnions);
            Console.WriteLine(pizzaAndExtraMushroomsAndOnions);
        }
        ...
        private enum PizzaType
        {
            Cheese,
            CheeseAndMushrooms,
            CheeseAndExtraMushrooms,
            CheeseAndExtraMushroomsAndOnions,
            Salami
        }
        ...
        private class NyPizzaStore : PizzaStore
        {
            protected override Pizza CreatePizza(PizzaType type)
            {
                ...
                switch (type)
                {
                    ...
                    case PizzaType.CheeseAndMushrooms:
                        return new NyStyleCheesePizzaWithMushrooms(ingredientFactory);
                    case PizzaType.CheeseAndExtraMushrooms:
                        return new NyStyleCheesePizzaWithExtraExtraMushrooms(ingredientFactory);
                    case PizzaType.CheeseAndExtraMushroomsAndOnions:
                        return new NyStyleCheesePizzaWithExtraExtraMushroomsAndOnions(ingredientFactory);
        ...
        private abstract class Pizza
        {
            ...
            protected IDough Dough { private get; set; }
            protected ISauce Sauce { private get; set; }
            protected ICheese Cheese { private get; set; }
            protected IClams Clams { private get; set; }
        ...
        private class NyStyleCheesePizzaWithMushrooms : Pizza
        {
            public NyStyleCheesePizzaWithMushrooms(IPizzaIngredientFactory ingredientFactory)
            {
                Name = "NY Style Sauce and Cheese and mushrooms pizza";
                Dough = ingredientFactory.CreateDough();
                Sauce = ingredientFactory.CreateSauce();
                Cheese = ingredientFactory.CreateCheese();
        ...
        private class NyStyleCheesePizzaWithExtraExtraMushrooms : Pizza
        {
            public NyStyleCheesePizzaWithExtraExtraMushrooms(IPizzaIngredientFactory ingredientFactory)
            {
                Name = "NY Style Sauce and Cheese and extra mushrooms pizza";
                Dough = ingredientFactory.CreateDough();
                Sauce = ingredientFactory.CreateSauce();
                Cheese = ingredientFactory.CreateCheese();
                Veggies.Add(new Mushroom());
        ...
        private class NyStyleCheesePizzaWithExtraExtraMushroomsAndOnions : Pizza
        {
            public NyStyleCheesePizzaWithExtraExtraMushroomsAndOnions(IPizzaIngredientFactory ingredientFactory)
            {
                Name = "NY Style Sauce and Cheese and extra mushrooms and onions pizza";
                Dough = ingredientFactory.CreateDough();
                Sauce = ingredientFactory.CreateSauce();
                Cheese = ingredientFactory.CreateCheese();
                Veggies.Add(new Mushroom());
